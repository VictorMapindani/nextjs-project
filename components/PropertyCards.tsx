...
// Define the shape of the `property` object using an interface
interface Property {
  id: unknown;
  name: string;
  type: string;
  ...
  rates: { // Add the rates field to match the structure you use in getRateDisplay
    monthly?: number;
    weekly?: number;
    nightly?: number;
  };
...
interface PropertyCardProps {
  property: Property; // Use the Property interface to type the prop
}
